...
import 'src/components/SalesTax/SalesTax.scss';
    ...
    return (
        <div className="taxes">
            <Grid container
                  ...
                  alignItems="center"
            >
                <Grid item xs={12} sm={12} md={6} lg={6}  className="taxes-column-left"  >
                    <Typography color="inherit" variant="body1" gutterBottom style={styles.taxesColumnLeft}>
                        Taxes for {capitalizeString(province)}.
                    </Typography>
                </Grid>
                <Grid item xs={12} sm={12} md={6} lg={6}  className="taxes-column-right" >
