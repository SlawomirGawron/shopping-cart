...
import 'src/components/ShoppingCart/SubTotal/SubTotal.scss';
    ...
    return (
        <div className="sub-total">
            <Grid container
                  ...
                  alignItems="center"
            >
                <Grid item xs={6} sm={6} md={6} lg={6}  className="sub-total-column-left"  >
                    <Typography color="inherit" variant="body1" gutterBottom style={styles.subTotalColumnLeft}>
                        Subtotal
                    </Typography>
                </Grid>
                <Grid item xs={6} sm={6} md={6} lg={6}  className="sub-total-column-right" >
